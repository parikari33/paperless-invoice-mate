    ...
    >
      <div
        className={cn(
          ...
          isDragging ? 'border-primary scale-[1.02] bg-primary/5' : 'border-muted hover:border-primary/50 hover:bg-primary/5',
        ...
        {previewUrl ? (
          ...
          <>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center text-xs text-muted-foreground">
            ...
            <div className="mt-4">
              <div className="relative px-4 py-2 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors flex items-center">
